...
# gatsby-starter-banshorian
 (a starter for gatsby-theme-banshorian)
...
Gave it a brush-up with a style-concept like **"Banshee series"** meets **"the mandalorian series"** and gave birth to showcase: project/person:application-development site.

Take it and make it your own

Please refer to ![gatsby-theme-banshorian](https://github.com/webmaeistro/gatsby-theme-banshorian) for the theme repo 

## want to contribute

fork it, do some change and pull request. contact me @ marander@pm.me or twitter @webmaeistro
